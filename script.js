        ...
        const equipmentData = [
            {
                ...
                specs: ["Грузоподъемность: 5000 кг", "Объем ковша: 3,5 м³", "Мощность двигателя: 162 л.с.", "Вес: 17,5 т", "Габариты: 8,2×2,8×3,5 м"],
            ...
            },
            {
                ...
                coordinates: [55.731244, 37.628423]
            },
            {
                id: 3,
                name: "Вакуумный погрузчик Volvo",
                price: "8500₽/час",
                image: 'imgs/Volvo.jpg',
                description: "Вакуумный погрузчик Volvo для транспортировки сыпучих материалов. Современное оборудование с высокой производительностью.",
                detailedDescription: "Вакуумный погрузчик Volvo с системой загрузки сыпучих материалов методом всасывания. Идеально подходит для работы с цементом, песком, зерном и другими сыпучими материалами. Оснащен системой фильтрации, предотвращающей выброс пыли в окружающую среду.",
            ...
            },
            {
                ...
                coordinates: [55.771244, 37.598423]
            },
            {
                id: 5,
                ...
                coordinates: [55.741244, 37.638423]
            },
            {
                id: 6,
                ...
                coordinates: [55.721244, 37.648423]
            },
            {
                id: 7,
                ...
                coordinates: [55.781244, 37.588423]
            },
            {
                id: 8,
...
function initMainMap() {
    ...
    L.marker([55.807256, 38.025507])
        .addTo(mainMap)
        .bindPopup('<b>Вакуумный погрузчик Volvo</b>')
    L.marker([55.80723, 38.02861])
        .addTo(mainMap)
        .bindPopup('<b>Мини погрузчик CASE</b>')
    L.marker([55.808579, 38.028106])
        .addTo(mainMap)
        .bindPopup('<b>Фронтальный Погрузчик XCMG</b>')
}
...
function initDetailMap(coordinates) {
    ...
    detailMap = L.map('detailMap').setView(coordinates, 14);
...
function showDetailPage(id) {
    ...
    initDetailMap(item.coordinates);
